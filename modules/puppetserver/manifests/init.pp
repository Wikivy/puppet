...
class puppetserver(
    ...
    git::clone { 'puppet':
        ...
        origin    => 'https://github.com/Wikivy/puppet',
        require   => Package['openvox-agent'],
    }
    ...
    git::clone { 'ssl':
        ...
        origin    => 'https://github.com/Wikivy/ssl',
        require   => Package['openvox-agent'],
    }
    ...
    git::clone { 'mediawiki-repos':
        ...
        origin    => 'https://github.com/Wikivy/mediawiki-repos',
        owner     => 'puppet',
        group     => 'puppet',
        require   => Package['openvox-agent'],
    }
    ...
    git::clone { 'pywikibot-config':
        ...
        origin    => 'https://github.com/Wikivy/pywikibot-config',
        owner     => 'puppet',
        group     => 'puppet',
        require   => Package['openvox-agent'],
    }
