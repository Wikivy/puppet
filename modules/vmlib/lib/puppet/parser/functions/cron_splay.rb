...
From: https://github.com/wikimedia/operations-puppet/blob/production/modules/wmflib/lib/puppet/parser/functions/cron_splay.rb
...
*Examples:*
    ...
    this_idx = ordered.index(lookupvar('facts')['networking']['fqdn'])
    if this_idx.nil?
