...
def check_up(nolog: bool, Debug: str | None = None, Host: str | None = None, domain: str = 'meta.wikivy.com', verify: bool = True, force: bool = False, port: int = 443, use_cert: bool = True) -> bool:
    ...
    if not up:
        ...
        print(f'Text: {"wikivy" in req.text} \n {req.text}')
